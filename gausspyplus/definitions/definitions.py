...
class SettingsDefault:
    ...
    overwrite: bool = field(
        default=True,
        metadata={"description": "Overwrite files [True/False]", "simple": False},
    )
    suffix: Optional[str] = field(
        default=None,
        metadata={"description": "Suffix added to filename [str]", "simple": False},
    )
    ...
    random_seed: int = field(
        default=111,
        metadata={"description": "Seed for random processes [int]", "simple": True},
    )
...
class SettingsDecomposition:
    ...
    alpha1: Optional[float] = field(
        default=None,
        metadata={"description": "First smoothing parameter [float]", "simple": True},
    )
